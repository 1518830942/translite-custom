...
export default function TitleBar({ onOpenSettings, onOpenShortcutSettings, onOpenCloseBehavior, onOpenTranslatePromptSettings, onOpenPolishPromptSettings, onOpenExplainPromptSettings, onClose, onQuit }: TitleBarProps) {
